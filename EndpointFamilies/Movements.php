...
/**
 * Handles the group of API endpoints falling under '/Movements/...'
 */
class Movements extends EndpointFamily
{
    const ENDPOINT_BASE = '/api/Movements';
